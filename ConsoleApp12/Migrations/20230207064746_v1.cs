    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Passangers", x => x.IdPassenger);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PassangerIdPassenger = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tickets_Passangers_PassangerIdPassenger",
                        column: x => x.PassangerIdPassenger,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_PassangerIdPassenger",
                table: "Tickets",
                column: "PassangerIdPassenger");
